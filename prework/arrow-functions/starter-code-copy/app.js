...
//Had issues trying to get the calculations to hapopen in one line so had to break out a code block
...
// //Arrow version that breaks everything because arrow functions are not constructors
...
// //Arrow function that breaks the code because it is not tied to the "this" scope of the student object I think
// const greeting = _ => `Hi, my name is ${this.name}`;
...
//    Following the console log on 219 "this" is a student object
// 2. What is "this" when joe.scopeArrow() is invoked?
//    Following the console log on 225 "this" refers to the entire window
// 3. Explain why "this" is different when an arrow function is used.
//    The difference is that the arrow function is not attached to the "student" object but instead scoped to the entire window because there is no encompassing function to define it's scope. 
